...
$id = $_GET['id'];
$edit = query("SELECT * FROM kategori_id WHERE id = $id")[0];
    ...
    <div class="content-wrapper pt-5 mx-auto">
      <div class="container card shadow overflow-hidden" style="width: 70%">
        <form action="" method="POST">
          <div class="row">
            <div class="col-lg-12 overflow-auto p-4" style="height: 220px" id="ams">
          ...
          <div class="col-12" action="POST">
            <input type="submit" name="simpan" value="Ubah data" class="btn-primary mb-3 mx-auto">
          </div>
        </form>
      </div>
    </div>
